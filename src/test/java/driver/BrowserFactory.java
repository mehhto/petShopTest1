        ...
        if (isRemoteRun) {
            ...
            switch (browserType) {
                case CHROME:
                    ...
                    return getRemoteWebDriverFromGrid(desiredCapabilities);
                case FIREFOX:
            ...
            switch (browserType) {
                ...
                default:
                    throw new IllegalStateException("Unknown browserType type! Please check your configuration");
            }
        }
    }


    private WebDriver getRemoteWebDriverFromGrid(DesiredCapabilities desiredCapabilities) {
